...
def complete_store(html):
    ...
    with open(os.path.join('awesomeyang.github.io/javascripts','rawpostdata.js'),'ab+') as f:  
        f.write(boutcome)
    with open(os.path.join('awesomeyang.github.io/javascripts','rawpostdata.js'),'rb+') as f:
        data=f.read().decode().split(';')
        data.pop(-1)
        with open(os.path.join('awesomeyang.github.io/javascripts','postdata.js'),'wb+') as f:
